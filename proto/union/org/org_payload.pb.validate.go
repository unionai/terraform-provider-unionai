...
// Validate checks the field values on UpdateError with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *UpdateError) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateError with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UpdateErrorMultiError, or
// nil if none found.
func (m *UpdateError) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateError) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UpdateErrorValidationError{
					field:  "Id",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UpdateErrorValidationError{
				field:  "Id",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return UpdateErrorMultiError(errors)
	}

	return nil
}

// UpdateErrorMultiError is an error wrapping multiple validation errors
// returned by UpdateError.ValidateAll() if the designated constraints aren't met.
type UpdateErrorMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateErrorMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateErrorMultiError) AllErrors() []error { return m }

// UpdateErrorValidationError is the validation error returned by
// UpdateError.Validate if the designated constraints aren't met.
type UpdateErrorValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateErrorValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateErrorValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateErrorValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateErrorValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateErrorValidationError) ErrorName() string { return "UpdateErrorValidationError" }

// Error satisfies the builtin error interface
func (e UpdateErrorValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UpdateErrorValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateErrorValidationError{}

// Validate checks the field values on BatchUpdateErrors with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *BatchUpdateErrors) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BatchUpdateErrors with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// BatchUpdateErrorsMultiError, or nil if none found.
func (m *BatchUpdateErrors) ValidateAll() error {
	return m.validate(true)
}

func (m *BatchUpdateErrors) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetErrors() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, BatchUpdateErrorsValidationError{
			...
			if err := v.Validate(); err != nil {
				return BatchUpdateErrorsValidationError{
					field:  fmt.Sprintf("Errors[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return BatchUpdateErrorsMultiError(errors)
	}

	return nil
}

// BatchUpdateErrorsMultiError is an error wrapping multiple validation errors
// returned by BatchUpdateErrors.ValidateAll() if the designated constraints
// aren't met.
type BatchUpdateErrorsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BatchUpdateErrorsMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m BatchUpdateErrorsMultiError) AllErrors() []error { return m }

// BatchUpdateErrorsValidationError is the validation error returned by
// BatchUpdateErrors.Validate if the designated constraints aren't met.
type BatchUpdateErrorsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BatchUpdateErrorsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BatchUpdateErrorsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BatchUpdateErrorsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BatchUpdateErrorsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BatchUpdateErrorsValidationError) ErrorName() string {
	return "BatchUpdateErrorsValidationError"
}

// Error satisfies the builtin error interface
func (e BatchUpdateErrorsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sBatchUpdateErrors.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = BatchUpdateErrorsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = BatchUpdateErrorsValidationError{}
