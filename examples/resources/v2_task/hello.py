#
# Simple workflow to show how to use TaskEnvironments.
#
# This is a sample environment. If this file changes, a new version gets
...
@env.task
def fn3(x: int) -> int:  # type annotations are recommended.
    slope, intercept = 2, 5
